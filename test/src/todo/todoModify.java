...
public class todoModify extends JFrame {
	...
	public void open() {
		...
		// 네모난 기본 배경 칠하지 않도록
		title.putClientProperty("excludeTheme", Boolean.FALSE);
		title.putClientProperty("roundPanel", Boolean.TRUE);
		ThemeManager.register("groupA", title);
		...
		// 네모난 기본 배경 칠하지 않도록
		one.putClientProperty("excludeTheme", Boolean.FALSE);
		one.putClientProperty("roundPanel", Boolean.TRUE);
		...
		// 네모난 기본 배경 칠하지 않도록
		two.putClientProperty("excludeTheme", Boolean.FALSE);
		two.putClientProperty("roundPanel", Boolean.TRUE);
		...
		// 네모난 기본 배경 칠하지 않도록
		three.putClientProperty("excludeTheme", Boolean.FALSE);
		three.putClientProperty("roundPanel", Boolean.TRUE);
		ThemeManager.register("groupA", three);
		...
		datebtn.addActionListener(e -> {
			new todoCalendar((year, month, day, dayWeek) -> datebtn
					.setText(year + "-" + month + "-" + day + "[" + dayWeek + "]"));
		});
		...
		// 네모난 기본 배경 칠하지 않도록
		four.putClientProperty("excludeTheme", Boolean.FALSE);
		four.putClientProperty("roundPanel", Boolean.TRUE);
		ThemeManager.register("groupA", four);
		...
		timebtn.addActionListener(e -> {
			new todoClock((hour, minute) -> timebtn.setText(hour + "시 " + minute + "분"));
		});
		...
		// 네모난 기본 배경 칠하지 않도록
		five.putClientProperty("excludeTheme", Boolean.FALSE);
		five.putClientProperty("roundPanel", Boolean.TRUE);
		ThemeManager.register("groupA", five);
		...
		// 네모난 기본 배경 칠하지 않도록
		six.putClientProperty("excludeTheme", Boolean.FALSE);
		six.putClientProperty("roundPanel", Boolean.TRUE);
		ThemeManager.register("groupA", six);
		six.setOpaque(false);
		...
		note.addFocusListener(new FocusListener() {
			@Override
			public void focusGained(FocusEvent e) {
				if (note.getText().equals("메모를 입력하세요"))
					note.setText("");
			}
