...
public class statisticsPanel extends JPanel {
	...
	public statisticsPanel(JPanel container, CardLayout cardLayout, todoListMake list, SetFrame parentFrame) {
		...
		topPanel.add(inventory, BorderLayout.CENTER);
		 ...
		 // 네모난 기본 배경 칠하지 않도록
		inventory.putClientProperty("excludeTheme", Boolean.FALSE);;
		inventory.putClientProperty("roundPanel", Boolean.TRUE);  
        ThemeManager.register("groupB", inventory);
		...
		// 네모난 기본 배경 칠하지 않도록
		middlePanel.putClientProperty("excludeTheme", Boolean.FALSE);
		middlePanel.putClientProperty("roundPanel", Boolean.TRUE);
		ThemeManager.register("groupA", middlePanel);
		...
		one.add(colorWork);
		one.add(work);
		one.add(progressBarWork);
		two.add(colorHealth);
		two.add(health);
		two.add(progressBarHealth);
		three.add(colorStudy);
		three.add(study);
		three.add(progressBarStudy);
		four.add(colorHobby);
		four.add(hobby);
		four.add(progressBarHobby);
		five.add(colorFinance);
		five.add(finance);
		five.add(progressBarFinance);
		six.add(colorOthers);
		six.add(others);
		six.add(progressBarOthers);
		...
		ThemeManager.register("groupA", bottomPanel);
